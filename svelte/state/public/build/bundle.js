...
var app = (function () {
    ...
    /* src/Cart/CartItem.svelte generated by Svelte v3.59.1 */
    const file$4 = "src/Cart/CartItem.svelte";

    // (28:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (31:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 32, 4, 791);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(32:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 25, 2, 533);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 26, 2, 552);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 24, 0, 526);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function displayDescription() {
    		...
    		products.subscribe(prods => {
    			$$invalidate(3, description = prods.find(({ id: pid }) => pid === id).description);
    		});
    	}
    ...
    /* src/Cart/Cart.svelte generated by Svelte v3.59.1 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 29, 6, 633);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (27:4) {#each $cart as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$cart*/ 1) cartitem_changes.id = /*item*/ ctx[1].id;
    			if (dirty & /*$cart*/ 1) cartitem_changes.title = /*item*/ ctx[1].title;
    			if (dirty & /*$cart*/ 1) cartitem_changes.price = /*item*/ ctx[1].price;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(27:4) {#each $cart as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 24, 2, 488);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 25, 2, 504);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 23, 0, 476);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $cart;
    	validate_store(customCart, 'cart');
    	component_subscribe($$self, customCart, $$value => $$invalidate(0, $cart = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ onDestroy, CartItem, cart: customCart, timer, $cart });
    	return [$cart];
    }
    ...
    /* src/Products/Product.svelte generated by Svelte v3.59.1 */
    const file$2 = "src/Products/Product.svelte";

    // (22:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 16, 4, 306);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$2, 17, 4, 327);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$2, 18, 4, 348);
    			add_location(div0, file$2, 15, 2, 296);
    			add_location(div1, file$2, 20, 2, 380);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$2, 14, 0, 272);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function addToCart() {
    		customCart.addItem({ id, title, price, description });
    	}
    ...
    /* src/Products/Products.svelte generated by Svelte v3.59.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 6, 2, 141);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 5, 0, 129);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
