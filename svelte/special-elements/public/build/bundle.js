...
var app = (function () {
    ...
    const file$2 = "src/FamilyNode.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(28:2) {#if member.isParent}",
    		ctx
    	});
    ...
    // (29:4) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:4) {#each member.children as child}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			hr = element("hr");
    			add_location(h1, file$2, 26, 2, 466);
    			add_location(hr, file$2, 32, 2, 609);
    			attr_dev(div, "class", "svelte-1111zfo");
    			toggle_class(div, "active", /*isActive*/ ctx[1]);
    			add_location(div, file$2, 25, 0, 411);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*setAsActive*/ ctx[2], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [member, isActive, setAsActive];
    }

    class FamilyNode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { member: 0 });
    ...
    // (67:2) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(67:2) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 56, 0, 1400);
    			add_location(button1, file, 59, 2, 1462);
    			attr_dev(div, "class", "svelte-ufz2tx");
    			add_location(div, file, 58, 0, 1454);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(document, "mouseenter", /*mouseenter_handler*/ ctx[6], false, false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const switchTitle = () => {
    		...
    		$$invalidate(1, currentTitle = word);
    	};
