...
var app = (function () {
    ...
    /* src/Modal.svelte generated by Svelte v3.59.1 */
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 55, 6, 1097);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*onClose*/ ctx[1], false, false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			p = element("p");
    			p.textContent = "Before close, agreed";
    			t4 = space();
    			button = element("button");
    			...
    			attr_dev(div0, "class", "backdrop svelte-nheja4");
    			add_location(div0, file$2, 39, 0, 747);
    			attr_dev(header, "class", "svelte-nheja4");
    			add_location(header, file$2, 41, 2, 813);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$2, 44, 2, 863);
    			add_location(p, file$2, 49, 4, 939);
    			add_location(button, file$2, 50, 4, 971);
    			attr_dev(div2, "class", "disclaimer");
    			add_location(div2, file$2, 48, 2, 910);
    			add_location(footer, file$2, 53, 2, 1039);
    			attr_dev(div3, "class", "modal svelte-nheja4");
    			add_location(div3, file$2, 40, 0, 791);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "click", /*onClose*/ ctx[1], false, false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (footer_slot) {
    				...
    				if (footer_slot_or_fallback && footer_slot_or_fallback.p && (!current || dirty & /*agreed*/ 1)) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [agreed, onClose, $$scope, slots, click_handler];
    }
    ...
    /* src/Product.svelte generated by Svelte v3.59.1 */
    const file$1 = "src/Product.svelte";

    // (22:2) {#if isBestSeller}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 22, 4, 439);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*isBestSeller*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 19, 2, 363);
    			add_location(h2, file$1, 20, 2, 389);
    			add_location(button0, file$1, 24, 2, 470);
    			add_location(button1, file$1, 25, 2, 522);
    			add_location(article, file$1, 18, 0, 351);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*addToCart*/ ctx[3], false, false, false, false),
    					listen_dev(button1, "click", /*deleteFromCart*/ ctx[4], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*productPrice*/ 2) set_data_dev(t3, /*productPrice*/ ctx[1]);

    			if (/*isBestSeller*/ ctx[2]) {
    				if (if_block) ; else {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (productTitle === undefined && !('productTitle' in $$props || $$self.$$.bound[$$self.$$.props['productTitle']])) {
    			console.warn("<Product> was created without expected prop 'productTitle'");
    		}

    		if (productPrice === undefined && !('productPrice' in $$props || $$self.$$.bound[$$self.$$.props['productPrice']])) {
    			console.warn("<Product> was created without expected prop 'productPrice'");
    		}
    	});

    	const writable_props = ['productTitle', 'productPrice', 'isBestSeller'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('isBestSeller' in $$props) $$invalidate(2, isBestSeller = $$props.isBestSeller);
    	};
    	...
    	return [productTitle, productPrice, isBestSeller, addToCart, deleteFromCart];
    }
    ...
    function get_each_context(ctx, list, i) {
    	...
    	child_ctx[11] = object_without_properties(list[i], ["id"]);
    	return child_ctx;
    }
    ...
    // (39:0) {#each products as { id, ...product }
    function create_each_block_1(key_1, ctx) {
    	let first;
    	let product;
    	let current;
    	const product_spread_levels = [/*product*/ ctx[11]];
    	let product_props = {};
    	...
    	product.$on("delete", /*deleteProduct*/ ctx[4]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			? get_spread_update(product_spread_levels, [get_spread_object(/*product*/ ctx[11])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:0) {#each products as { id, ...product }",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	modal = new Modal({
    			props: {
    				$$slots: {
    					footer: [
    						create_footer_slot,
    						({ didAgree: closable }) => ({ 6: closable }),
    						({ didAgree: closable }) => closable ? 64 : 0
    					],
    					header: [
    						create_header_slot,
    						({ didAgree: closable }) => ({ 6: closable }),
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, closable, showModal*/ 65601) {
    ...
    // (48:4) {#each products as { id, ...product }
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:4) {#each products as { id, ...product }",
    		ctx
    	});
    ...
    // (46:2) <Modal on:close={() => (showModal = false)} let:didAgree={closable}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*products, addToCart, deleteProduct*/ 28) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(46:2) <Modal on:close={() => (showModal = false)} let:didAgree={closable}>",
    		ctx
    	});
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 46, 4, 1157);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text("Confirm");
    			button.disabled = button_disabled_value = !/*closable*/ ctx[6];
    			attr_dev(button, "slot", "footer");
    			add_location(button, file, 54, 4, 1365);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*closable*/ 64 && button_disabled_value !== (button_disabled_value = !/*closable*/ ctx[6])) {
    				prop_dev(button, "disabled", button_disabled_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 42, 0, 1001);
    			attr_dev(textarea, "rows", "5");
    			textarea.value = /*text*/ ctx[1];
    			add_location(textarea, file, 62, 0, 1503);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(textarea, "keydown", /*transform*/ ctx[5], false, false, false, false)
    				];
