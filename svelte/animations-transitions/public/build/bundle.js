...
var app = (function () {
    ...
    /* src/Spring.svelte generated by Svelte v3.59.1 */
    ...
    // (63:4) {#each $cards as card, i (card.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			set_style(div, "background", /*card*/ ctx[6].color);
    			set_style(div, "transform", "rotateZ(" + /*$cardPos*/ ctx[1][/*i*/ ctx[8]].rotation + "deg) translateX(" + /*$cardPos*/ ctx[1][/*i*/ ctx[8]].dx + "px)");
    			add_location(div, file$1, 64, 6, 1168);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:4) {#each $cards as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$1, 60, 0, 1018);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler = i => discard(i);
    	...
    	return [$cards, $cardPos, cards, cardPos, discard, click_handler];
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*discardBox, boxes, console*/ 20) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[7](/*box*/ ctx[13]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "svelte-1msdk0u");
    			add_location(div, file, 47, 4, 1078);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "introstart", /*introstart_handler*/ ctx[8], false, false, false, false),
    					listen_dev(div, "introend", /*introend_handler*/ ctx[9], false, false, false, false),
    					listen_dev(div, "outrostart", /*outrostart_handler*/ ctx[10], false, false, false, false),
    					listen_dev(div, "outroend", /*outroend_handler*/ ctx[11], false, false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes*/ 4) && t0_value !== (t0_value = /*box*/ ctx[13] + "")) set_data_dev(t0, t0_value);
    		},
    		r: function measure() {
    		...
    		i: function intro(local) {
    			...
    			if (local) {
    				add_render_callback(() => {
    					if (!current) return;
    					if (!div_transition) div_transition = create_bidirectional_transition(div, fly, { x: 500, y: 1200 }, true);
    		...
    		o: function outro(local) {
    			if (local) {
    				if (!div_transition) div_transition = create_bidirectional_transition(div, fly, { x: 500, y: 1200 }, false);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(46:2) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 35, 0, 718);
    			add_location(hr, file, 39, 0, 872);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 41, 0, 880);
    			add_location(button1, file, 42, 0, 924);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*boxInput*/ ctx[0]);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*addBox*/ ctx[3], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*boxInput*/ 1 && input.value !== /*boxInput*/ ctx[0]) {
    				set_input_value(input, /*boxInput*/ ctx[0]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addBox = () => {
    		$$invalidate(2, boxes = [boxInput, ...boxes]);
    	};

    	const discardBox = box => {
    		$$invalidate(2, boxes = boxes.filter(el => el !== box));
    	};
    	...
    	const click_handler_1 = box => discardBox(box);
    	const introstart_handler = () => console.log("Adding element starts");
    	const introend_handler = () => console.log("Adding element ends");
    	const outrostart_handler = () => console.log("Removing element starts");
    	const outroend_handler = () => console.log("Removing element ends");
